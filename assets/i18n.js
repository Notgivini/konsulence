...
(function(){
  ...
  const T = {
    ...
    de: {
      ...
      'portfolio.eyebrow':'DSS-Portfolio','portfolio.heading':'Arbeiten, die Sie jetzt <em>öffnen</em> können.','portfolio.sub':'Jedes Projekt unten ist live und funktioniert. Öffnen Sie es und überzeugen Sie sich selbst.','portfolio.framing':'Echte Arbeiten für Kunden in Albanien. Dieselbe Qualität, und sogar besser, in Ihrer Sprache gebaut.','portfolio.crumb':'Unsere Arbeiten','portfolio.closing.h2':'Möchten Sie etwas Ähnliches <em>für Ihr Unternehmen?</em>','portfolio.seeAll':'Gesamtes Portfolio ansehen','flagship.eyebrow':'Unser größtes Projekt','flagship.lead':'Unsere komplette Plattform für Barbershops. Kunden buchen über Google, Instagram und QR-Code, mit Live-Warteschlange für Walk-ins, automatischen Wiederbuchungs-Erinnerungen und der Historie jedes Kunden. Von DSS entwickelt und betrieben.','flagship.cta':'NexTrim ansehen','flagship.videosLabel':'Videos','flagship.heroAria':'NexTrim-Werbespot','flagship.v.hook':'Warum NexTrim','flagship.v.dashboard':'Das Dashboard des Barbers','flagship.v.client':'So bucht ein Kunde','flagship.v.owner':'So funktioniert es für den Barber',
    ...
    es: {
      ...
      'portfolio.eyebrow':'Portafolio DSS','portfolio.heading':'Trabajos que puede <em>abrir</em> ahora mismo.','portfolio.sub':'Cada proyecto de abajo está en línea y funciona. Ábralo y compruébelo usted mismo.','portfolio.framing':'Trabajos reales para clientes en Albania. La misma calidad, y aún mejor, en su idioma.','portfolio.crumb':'Nuestros Trabajos','portfolio.closing.h2':'¿Quiere algo similar <em>para su negocio?</em>','portfolio.seeAll':'Ver todo el portafolio','flagship.eyebrow':'Nuestro proyecto más grande','flagship.lead':'Nuestra plataforma completa para barberías. Los clientes reservan desde Google, Instagram y código QR, con cola en vivo para walk-ins, recordatorios automáticos y el historial de cada cliente. Desarrollada y gestionada por DSS.','flagship.cta':'Visitar NexTrim','flagship.videosLabel':'Vídeos','flagship.heroAria':'Anuncio de NexTrim','flagship.v.hook':'Por qué NexTrim','flagship.v.dashboard':'El panel del barbero','flagship.v.client':'Cómo reserva un cliente','flagship.v.owner':'Cómo funciona para el barbero',
