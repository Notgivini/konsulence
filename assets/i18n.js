...
(function(){
  ...
  const T = {
    sq: {
      ...
      'btn.writeEmail':'Shkruaj email','btn.writeDss':'E-Mail DSS','btn.argearServices':'Shërbimet arGEar',
      ...
      'services.s7.h2':'e‑<em>Faturë.</em>','services.s7.p':'Punojmë mbi pesë platformat fiskale të miratuara që nga viti 2021. Ju nuk mendoni më për faturën, ne e dërgojmë.','services.dss.p':'Departamenti i Zgjidhjeve Digjitale dhe Software: website, aplikacione, dyqane online, menu digjitale me QR, sisteme rezervimi dhe profile Google Maps të optimizuara.',
      ...
      'dss.offer.eyebrow':'Linja DSS','dss.offer.h2':'Çfarë <em>ndërtojmë</em><br/>për biznesin tuaj.','dss.offer.note':'Keni një ide apo nevojë tjetër për software? Na shkruani dhe bisedojmë për zgjidhjen dhe çmimin.',
      'dss.offer.i1.h3':'Website &amp; <em>aplikacione</em>','dss.offer.i1.p':'Faqe dhe aplikacione web të shpejta, në çdo gjuhë, të optimizuara për çdo pajisje.',
      'dss.offer.i2.h3':'Menu online <em>e personalizuar</em>','dss.offer.i2.p':'Menu digjitale që hapet menjëherë në telefon, në çdo gjuhë, bashkë me një QR-Code për tavolinën.',
      ...
      'dss.offer.i4.h3':'Sisteme <em>rezervimi</em>','dss.offer.i4.p':'Rezervime online direkt nga faqja, aplikacioni ose nga WhatsApp.',
      ...
      'dss.offer.i6.h3':'QR-Code për <em>vlerësime</em>','dss.offer.i6.p':'QR-Code të personalizuar e gati për printim, që e çojnë klientin direkt te vlerësimi në Google.',
      ...
      // DSS orbital nodes
      'dss.n1.title':'Website & Aplikacione','dss.n1.badge':'01 · Web','dss.n1.desc':'Faqe dhe aplikacione web të shpejta, në çdo gjuhë, të optimizuara për çdo pajisje.',
      'dss.n2.title':'Menu Online të Personalizuar','dss.n2.badge':'02 · Menu','dss.n2.desc':'Menu digjitale që hapet menjëherë në telefon, në çdo gjuhë, bashkë me një QR-Code për tavolinën.',
      ...
      'dss.n4.title':'Sisteme Rezervimi','dss.n4.badge':'04 · Booking','dss.n4.desc':'Rezervime online direkt nga faqja, aplikacioni ose nga WhatsApp.',
      ...
      'dss.n6.title':'QR-Code për Vlerësime','dss.n6.badge':'06 · QR','dss.n6.desc':'QR-Code të personalizuar e gati për printim, që e çojnë klientin direkt te vlerësimi në Google.',
      // Portfolio (DSS)
      ...
      'portfolio.eyebrow':'Portofoli DSS','portfolio.heading':'Punë që mund t\'i <em>hapni</em> tani.','portfolio.sub':'Çdo projekt më poshtë është online dhe funksionon. Hapeni dhe shikojeni vetë.','portfolio.framing':'Punë reale për klientë në Shqipëri. Të njëjtën cilësi, madje edhe më të mirë, e ndërtojmë në gjuhën tuaj.','portfolio.crumb':'Punët Tona','portfolio.closing.h2':'Doni diçka të ngjashme për <em>biznesin tuaj?</em>','portfolio.seeAll':'Shiko gjithë portofolin','flagship.eyebrow':'Projekti ynë më i madh','flagship.lead':'Aplikacioni i parë në Europë që bashkon Radhën Live me rezervimet online dhe një sistem të plotë menaxhimi për berberë dhe parukeri. Klientët rezervojnë nga linku, Google Maps, Instagrami dhe QR-Code. E ndërtuar dhe e mirëmbajtur nga DSS arGEar. Provoje 14 ditë falas.','flagship.cta':'Vizito NexTrim','flagship.videosLabel':'Videos','flagship.heroAria':'Reklama e NexTrim','flagship.v.hook':'Pse NexTrim','flagship.v.dashboard':'Dashboard-i i berberit','flagship.v.client':'Si rezervon klienti','flagship.v.owner':'Si funksionon për berberin',
      // Calculator
    ...
    en: {
      ...
      'services.s7.h2':'e‑<em>Faturë.</em>','services.s7.p':'We work on five approved fiscal platforms, since 2021. You no longer think about the invoice, we send it.','services.dss.p':'The Digital Solutions and Software department: websites, apps, online stores, digital QR menus, booking systems and optimized Google Maps profiles.',
      ...
      'dss.offer.eyebrow':'DSS lines','dss.offer.h2':'What we <em>build</em><br/>for your business.','dss.offer.note':"Have another software idea or need? Get in touch and we'll discuss the solution and the price.",
      'dss.offer.i1.h3':'Websites &amp; <em>apps</em>','dss.offer.i1.p':'Fast websites and web apps, in any language, optimised for every device.',
      'dss.offer.i2.h3':'Personalized online <em>menu</em>','dss.offer.i2.p':'A digital menu that opens instantly on the phone, in any language, with its own QR-Code for the table.',
      'dss.offer.i3.h3':'E-commerce <em>stores</em>','dss.offer.i3.p':'Online shops where customers browse and order, with cart and checkout, simple for you to manage.',
      'dss.offer.i4.h3':'Booking <em>systems</em>','dss.offer.i4.p':'Online reservations straight from the website, the app or WhatsApp.',
      ...
      'dss.offer.i6.h3':'QR-Codes for <em>reviews</em>','dss.offer.i6.p':'Branded, print-ready QR-Codes that take customers straight to a Google review.',
      ...
      'dss.n1.title':'Websites & Apps','dss.n1.badge':'01 · Web','dss.n1.desc':'Fast websites and web apps, in any language, optimised for every device.',
      'dss.n2.title':'Personalized Online Menu','dss.n2.badge':'02 · Menu','dss.n2.desc':'A digital menu that opens instantly on the phone, in any language, with its own QR-Code for the table.',
      'dss.n3.title':'E-commerce Stores','dss.n3.badge':'03 · Shop','dss.n3.desc':'Online shops where customers browse and order, with cart and checkout, simple for you to manage.',
      'dss.n4.title':'Booking Systems','dss.n4.badge':'04 · Booking','dss.n4.desc':'Online reservations straight from the website, the app or WhatsApp.',
      ...
      'portfolio.eyebrow':'DSS Portfolio','portfolio.heading':'Work you can <em>open</em> right now.','portfolio.sub':'Every project below is live and working. Open it and see for yourself.','portfolio.framing':'Real work for clients in Albania. We build the same quality, and even better, in your language.','portfolio.crumb':'Our Work','portfolio.closing.h2':'Want something like this <em>for your business?</em>','portfolio.seeAll':'See the full portfolio','flagship.eyebrow':'Our biggest project','flagship.lead':'The first app in Europe to combine a Live Queue with online bookings and a complete management system for barbers and hair salons. Clients book from your link, Google Maps, Instagram and QR-Code. Built and maintained by DSS arGEar. Try it free for 14 days.','flagship.cta':'Visit NexTrim','flagship.videosLabel':'Videos','flagship.heroAria':'NexTrim ad','flagship.v.hook':'Why NexTrim','flagship.v.dashboard':'The barber’s dashboard','flagship.v.client':'How a client books','flagship.v.owner':'How it works for the barber',
    ...
    it: {
      ...
      'btn.writeEmail':'Scrivi email','btn.writeDss':'Email DSS','btn.argearServices':'Servizi arGEar',
      ...
      'services.s7.h2':'e‑<em>Faturë.</em>','services.s7.p':'Lavoriamo su cinque piattaforme fiscali approvate, dal 2021. Voi non pensate più alla fattura, la inviamo noi.','services.dss.p':'Il reparto di soluzioni digitali e software: siti web, app, negozi online, menu digitali con QR, sistemi di prenotazione e profili Google Maps ottimizzati.',
      ...
      'dss.offer.eyebrow':'Linee DSS','dss.offer.h2':'Cosa <em>costruiamo</em><br/>per la vostra impresa.','dss.offer.note':"Avete un'altra idea o esigenza software? Scriveteci e parliamo della soluzione e del prezzo.",
      'dss.offer.i1.h3':'Siti web &amp; <em>app</em>','dss.offer.i1.p':'Siti web e web app veloci, in qualsiasi lingua, ottimizzati per ogni dispositivo.',
      'dss.offer.i2.h3':'Menù online <em>personalizzato</em>','dss.offer.i2.p':'Un menù digitale che si apre subito sul telefono, in qualsiasi lingua, con un QR-Code per il tavolo.',
      'dss.offer.i3.h3':'Negozi <em>e-commerce</em>','dss.offer.i3.p':'Negozi online dove i clienti sfogliano e ordinano, con carrello e pagamento, semplici da gestire.',
      'dss.offer.i4.h3':'Sistemi di <em>prenotazione</em>','dss.offer.i4.p':'Prenotazioni online direttamente dal sito, dall’app o da WhatsApp.',
      ...
      'dss.offer.i6.h3':'QR-Code per <em>recensioni</em>','dss.offer.i6.p':'QR-Code personalizzati e pronti per la stampa che portano il cliente dritto a una recensione Google.',
      ...
      'dss.n1.title':'Siti web & app','dss.n1.badge':'01 · Web','dss.n1.desc':'Siti web e web app veloci, in qualsiasi lingua, ottimizzati per ogni dispositivo.',
      'dss.n2.title':'Menù online personalizzato','dss.n2.badge':'02 · Menu','dss.n2.desc':'Un menù digitale che si apre subito sul telefono, in qualsiasi lingua, con un QR-Code per il tavolo.',
      'dss.n3.title':'Negozi e-commerce','dss.n3.badge':'03 · Shop','dss.n3.desc':'Negozi online dove i clienti sfogliano e ordinano, con carrello e pagamento, semplici da gestire.',
      'dss.n4.title':'Sistemi di prenotazione','dss.n4.badge':'04 · Booking','dss.n4.desc':'Prenotazioni online direttamente dal sito, dall’app o da WhatsApp.',
      ...
      'dss.n6.title':'QR-Code per recensioni','dss.n6.badge':'06 · QR','dss.n6.desc':'QR-Code personalizzati e pronti per la stampa che portano il cliente dritto a una recensione Google.',
      ...
      'portfolio.eyebrow':'Portfolio DSS','portfolio.heading':'Lavori che potete <em>aprire</em> subito.','portfolio.sub':'Ogni progetto qui sotto è online e funzionante. Apritelo e verificate voi stessi.','portfolio.framing':'Lavori reali per clienti in Albania. La stessa qualità, e anche migliore, costruita nella vostra lingua.','portfolio.crumb':'I Nostri Lavori','portfolio.closing.h2':'Desidera qualcosa di simile <em>per la sua attività?</em>','portfolio.seeAll':'Vedi tutto il portfolio','flagship.eyebrow':'Il nostro progetto più grande','flagship.lead':'La prima app in Europa a unire la Coda Live con le prenotazioni online e un sistema di gestione completo per barbieri e parrucchieri. I clienti prenotano dal link, Google Maps, Instagram e QR-Code. Sviluppata e gestita da DSS arGEar. Provala gratis per 14 giorni.','flagship.cta':'Visita NexTrim','flagship.videosLabel':'Video','flagship.heroAria':'Spot NexTrim','flagship.v.hook':'Perché NexTrim','flagship.v.dashboard':'La dashboard del barbiere','flagship.v.client':'Come prenota un cliente','flagship.v.owner':'Come funziona per il barbiere',
    ...
    de: {
      ...
      'btn.writeEmail':'E‑Mail senden','btn.writeDss':'E-Mail DSS','btn.argearServices':'arGEar Leistungen',
      ...
      'services.s7.h2':'e‑<em>Faturë.</em>','services.s7.p':'Wir arbeiten seit 2021 auf fünf zugelassenen Fiskalplattformen. Sie denken nicht mehr an die Rechnung, wir versenden sie.','services.dss.p':'Die Abteilung für digitale Lösungen und Software: Websites, Apps, Onlineshops, digitale QR‑Menüs, Buchungssysteme und optimierte Google‑Maps‑Profile.',
      ...
      'dss.offer.eyebrow':'DSS‑Linien','dss.offer.h2':'Was wir <em>bauen</em><br/>für Ihr Unternehmen.','dss.offer.note':'Haben Sie eine weitere Software-Idee oder einen Bedarf? Schreiben Sie uns, und wir besprechen die Lösung und den Preis.',
      'dss.offer.i1.h3':'Websites &amp; <em>Apps</em>','dss.offer.i1.p':'Schnelle Websites und Web-Apps, in jeder Sprache, für jedes Gerät optimiert.',
      'dss.offer.i2.h3':'Personalisierte <em>Online-Speisekarte</em>','dss.offer.i2.p':'Eine digitale Speisekarte, die sofort am Handy öffnet, in jeder Sprache, mit eigenem QR-Code für den Tisch.',
      'dss.offer.i3.h3':'<em>E-Commerce</em>-Shops','dss.offer.i3.p':'Online-Shops, in denen Kunden stöbern und bestellen, mit Warenkorb und Kasse, einfach zu verwalten.',
      'dss.offer.i4.h3':'<em>Reservierungs</em>systeme','dss.offer.i4.p':'Online-Reservierungen direkt über die Website, die App oder WhatsApp.',
      ...
      'dss.offer.i6.h3':'QR-Codes für <em>Bewertungen</em>','dss.offer.i6.p':'Gebrandete, druckfertige QR-Codes, die Kunden direkt zur Google-Bewertung führen.',
      ...
      'dss.n1.title':'Websites & Apps','dss.n1.badge':'01 · Web','dss.n1.desc':'Schnelle Websites und Web-Apps, in jeder Sprache, für jedes Gerät optimiert.',
      'dss.n2.title':'Personalisierte Online-Speisekarte','dss.n2.badge':'02 · Menu','dss.n2.desc':'Eine digitale Speisekarte, die sofort am Handy öffnet, in jeder Sprache, mit eigenem QR-Code für den Tisch.',
      'dss.n3.title':'E-Commerce-Shops','dss.n3.badge':'03 · Shop','dss.n3.desc':'Online-Shops, in denen Kunden stöbern und bestellen, mit Warenkorb und Kasse, einfach zu verwalten.',
      'dss.n4.title':'Reservierungssysteme','dss.n4.badge':'04 · Booking','dss.n4.desc':'Online-Reservierungen direkt über die Website, die App oder WhatsApp.',
      ...
      'portfolio.eyebrow':'DSS-Portfolio','portfolio.heading':'Arbeiten, die Sie jetzt <em>öffnen</em> können.','portfolio.sub':'Jedes Projekt unten ist live und funktioniert. Öffnen Sie es und überzeugen Sie sich selbst.','portfolio.framing':'Echte Arbeiten für Kunden in Albanien. Dieselbe Qualität, und sogar besser, in Ihrer Sprache gebaut.','portfolio.crumb':'Unsere Arbeiten','portfolio.closing.h2':'Möchten Sie etwas Ähnliches <em>für Ihr Unternehmen?</em>','portfolio.seeAll':'Gesamtes Portfolio ansehen','flagship.eyebrow':'Unser größtes Projekt','flagship.lead':'Die erste App in Europa, die eine Live-Warteschlange mit Online-Buchungen und einem kompletten Verwaltungssystem für Barbershops und Friseure verbindet. Kunden buchen über Ihren Link, Google Maps, Instagram und QR-Code. Entwickelt und betreut von DSS arGEar. 14 Tage kostenlos testen.','flagship.cta':'NexTrim ansehen','flagship.videosLabel':'Videos','flagship.heroAria':'NexTrim-Werbespot','flagship.v.hook':'Warum NexTrim','flagship.v.dashboard':'Das Dashboard des Barbers','flagship.v.client':'So bucht ein Kunde','flagship.v.owner':'So funktioniert es für den Barber',
    ...
    es: {
      ...
      'btn.writeEmail':'Enviar correo','btn.writeDss':'Email DSS','btn.argearServices':'Servicios arGEar',
      ...
      'services.s7.h2':'e‑<em>Faturë.</em>','services.s7.p':'Trabajamos sobre cinco plataformas fiscales aprobadas, desde 2021. Usted ya no piensa en la factura, nosotros la enviamos.','services.dss.p':'El departamento de soluciones digitales y software: sitios web, apps, tiendas online, menús digitales con QR, sistemas de reserva y perfiles de Google Maps optimizados.',
      ...
      'dss.offer.eyebrow':'Líneas DSS','dss.offer.h2':'Lo que <em>construimos</em><br/>para su empresa.','dss.offer.note':'¿Tiene otra idea o necesidad de software? Escríbanos y hablamos de la solución y del precio.',
      'dss.offer.i1.h3':'Webs y <em>apps</em>','dss.offer.i1.p':'Sitios web y apps web rápidos, en cualquier idioma, optimizados para cada dispositivo.',
      'dss.offer.i2.h3':'Menú online <em>personalizado</em>','dss.offer.i2.p':'Un menú digital que se abre al instante en el móvil, en cualquier idioma, con su propio código QR para la mesa.',
      'dss.offer.i3.h3':'Tiendas <em>e-commerce</em>','dss.offer.i3.p':'Tiendas online donde los clientes navegan y compran, con carrito y pago, fáciles de gestionar.',
      'dss.offer.i4.h3':'Sistemas de <em>reservas</em>','dss.offer.i4.p':'Reservas online directamente desde el sitio, la app o WhatsApp.',
      ...
      'dss.offer.i6.h3':'Códigos QR para <em>reseñas</em>','dss.offer.i6.p':'Códigos QR personalizados y listos para imprimir que llevan al cliente directo a una reseña de Google.',
      ...
      'dss.n1.title':'Webs y apps','dss.n1.badge':'01 · Web','dss.n1.desc':'Sitios web y apps web rápidos, en cualquier idioma, optimizados para cada dispositivo.',
      'dss.n2.title':'Menú online personalizado','dss.n2.badge':'02 · Menu','dss.n2.desc':'Un menú digital que se abre al instante en el móvil, en cualquier idioma, con su propio código QR para la mesa.',
      'dss.n3.title':'Tiendas e-commerce','dss.n3.badge':'03 · Shop','dss.n3.desc':'Tiendas online donde los clientes navegan y compran, con carrito y pago, fáciles de gestionar.',
      'dss.n4.title':'Sistemas de reservas','dss.n4.badge':'04 · Booking','dss.n4.desc':'Reservas online directamente desde el sitio, la app o WhatsApp.',
      ...
      'portfolio.eyebrow':'Portafolio DSS','portfolio.heading':'Trabajos que puede <em>abrir</em> ahora mismo.','portfolio.sub':'Cada proyecto de abajo está en línea y funciona. Ábralo y compruébelo usted mismo.','portfolio.framing':'Trabajos reales para clientes en Albania. La misma calidad, y aún mejor, en su idioma.','portfolio.crumb':'Nuestros Trabajos','portfolio.closing.h2':'¿Quiere algo similar <em>para su negocio?</em>','portfolio.seeAll':'Ver todo el portafolio','flagship.eyebrow':'Nuestro proyecto más grande','flagship.lead':'La primera app en Europa que combina una Cola en Vivo con las reservas online y un sistema de gestión completo para barberías y peluquerías. Los clientes reservan desde su enlace, Google Maps, Instagram y código QR. Desarrollada y mantenida por DSS arGEar. Pruébela gratis 14 días.','flagship.cta':'Visitar NexTrim','flagship.videosLabel':'Vídeos','flagship.heroAria':'Anuncio de NexTrim','flagship.v.hook':'Por qué NexTrim','flagship.v.dashboard':'El panel del barbero','flagship.v.client':'Cómo reserva un cliente','flagship.v.owner':'Cómo funciona para el barbero',
