...
(function(){
  ...
  const T = {
    ...
    de: {
      ...
      'portfolio.eyebrow':'DSS-Portfolio','portfolio.heading':'Arbeiten, die Sie jetzt <em>öffnen</em> können.','portfolio.sub':'Jedes Projekt unten ist live und funktioniert. Öffnen Sie es und überzeugen Sie sich selbst.','portfolio.framing':'Echte Arbeiten für Kunden in Albanien. Dieselbe Qualität, und sogar besser, in Ihrer Sprache gebaut.','portfolio.crumb':'Unsere Arbeiten','portfolio.closing.h2':'Möchten Sie etwas Ähnliches <em>für Ihr Unternehmen?</em>','portfolio.seeAll':'Gesamtes Portfolio ansehen','flagship.eyebrow':'Unser größtes Projekt','flagship.lead':'Die erste App in Europa, die eine Live-Warteschlange mit Online-Buchungen und einem kompletten Verwaltungssystem für Barbershops und Friseure verbindet. Kunden buchen über Ihren Link, Google Maps, Instagram und QR-Code, mit automatischen Wiederbuchungs-Erinnerungen und der Historie jedes Kunden. Entwickelt und betreut von DSS arGEar. 14 Tage kostenlos testen.','flagship.cta':'NexTrim ansehen','flagship.videosLabel':'Videos','flagship.heroAria':'NexTrim-Werbespot','flagship.v.hook':'Warum NexTrim','flagship.v.dashboard':'Das Dashboard des Barbers','flagship.v.client':'So bucht ein Kunde','flagship.v.owner':'So funktioniert es für den Barber',
